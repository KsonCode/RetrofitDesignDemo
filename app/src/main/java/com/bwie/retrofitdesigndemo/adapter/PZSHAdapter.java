...
public class PZSHAdapter extends RecyclerView.Adapter<PZSHAdapter.VH> {

    private Context context;
    private List<HomeMultipartEntity.Home> list;

    public PZSHAdapter(Context context, List<HomeMultipartEntity.Home> list) {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.pzsh_subitem_layout,parent,false);
        return new VH(view);
    }
